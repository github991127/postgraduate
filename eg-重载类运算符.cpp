...
class A{
    ...
    public:
        ...
        A &operator++(){++i;return *this;}//&operator不影响
        A operator++(int){A tmp=*this;i++;return tmp;}//必须不是&operator，返回类内新创建变量的引用非法
        friend ostream &operator<<(ostream &os,const A &a){os<<a.i;return os;}//必须是&operator
};
int main ()
{
    A a1(1),a2(2);
